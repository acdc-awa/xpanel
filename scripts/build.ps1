...
$env:GOOS = "linux"
$env:GOARCH = "amd64"
& go build "-ldflags" "-X github.com/acdc-awa/xpanel/internal/agent/upgrade.Version=$Version" `
...
& go build -tags embedagent `
  "-ldflags" "-X github.com/acdc-awa/xpanel/internal/master/embed.AgentVersion=$Version" `
